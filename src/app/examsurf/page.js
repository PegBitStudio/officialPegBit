          ...
          <div className="container">
            ...
            <div className="responsive-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '20px' }}>
              {[
                ...
                { icon: '🧠', title: 'Intelligent Generation', desc: 'Thousands of unique practice questions generated by AI, mapped to the official syllabus and 10 years of past exam patterns.', color: 'var(--indigo)' },
                { icon: '💻', title: 'JAMB CBT Simulator', desc: 'Practice on the exact interface used in JAMB centres. Authentic timer, question palette, and calculator.', color: 'var(--gold-light)' },
